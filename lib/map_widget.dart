...
class _MapWidgetState extends State<MapWidget> {
  ...
  void _onMapCreated(GoogleMapController controller) async {
    ...
    positionManager.toggleListening();
    _currentLatLng =
        LatLng(positionManager.activePosition.latitude, positionManager.activePosition.longitude);
  }
  ...
  Widget _mapView() {
    return GoogleMap(
      ...
      initialCameraPosition: CameraPosition(
        target: _currentLatLng ?? LatLng(37.4219999, -122.0862462),
        zoom: 11.0,
      ),
    );
  }
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: CupertinoButton(
            ...
            onPressed: positionManager.toggleListening
        ),
      ),
    );
  }
